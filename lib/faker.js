...
var fakerCatagories = __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, address), commerce), company), database), datatype), date), finance), git), hacker), helpers), image), internet), lorem), music), name), phone), random), system), vehicle);
