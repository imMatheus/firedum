...
function firedumCreateUser(_a) {
    var amountOfUsers = _a.amountOfUsers, userFields = _a.userFields, usersCollectionReference = _a.usersCollectionReference;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _b.label = 1;
                case 1:
                    if (!(i < (amountOfUsers || 1))) return [3 /*break*/, 10];
                ...
                case 3:
                    ...
                    if (!usersCollectionReference) return [3 /*break*/, 5];
