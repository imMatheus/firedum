...
function firedumCreateUser(_a) {
	var _b = _a.amountOfUsers,
		amountOfUsers = _b === void 0 ? 1 : _b,
		fields = _a.fields,
		collectionReference = _a.collectionReference;
		...
		return __generator(this, function (_c) {
			switch (_c.label) {
				...
				case 4:
					return [
						2 /*return*/,
						{ data: data, ids: ids, reference: collectionReference }
					];
			}
		});
	});
