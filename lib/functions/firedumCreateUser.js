                ...
                case 0:
                    ...
                    _loop_1 = function (i) {
                        ...
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                case 0:
                                    password = (0, getRandomString_1.default)(16);
                                    email = (0, getRandomString_1.default)(12) + '@' + (0, getRandomString_1.default)(12) + '.com';
                                    _d.label = 1;
                                case 1:
                                    _d.trys.push([1, 3, , 4]);
                                    return [4 /*yield*/, (0, auth_1.createUserWithEmailAndPassword)(initFirebase_1.auth, email, password).then(function (currentUser) { return __awaiter(_this, void 0, void 0, function () {
                                            var generatedFields, _a, _b, _i, field, value;
                                            var _c;
                                            return __generator(this, function (_d) {
                                                switch (_d.label) {
                                                    case 0:
                                                    ...
                                                    case 1:
                                                        ...
                                                        if (!(typeof fields[field] === 'string')) return [3 /*break*/, 6];
                                                        if (!(!fields[field] &&
                                                            faker_1.default[field] &&
                                                            faker_1.default[field]())) return [3 /*break*/, 3];
                                                    ...
                                                    case 3:
                                                        if (!(fields[field].length > 1 &&
                                                            fields[field][0] === ':' &&
                                                            faker_1.default[fields[field].slice(1)])) return [3 /*break*/, 5];
                                                        return [4 /*yield*/, faker_1.default[fields[field].slice(1)]()];
                                                    case 4:
                                                        value = _d.sent();
                                                        generatedFields[field] = value;
                                                        return [3 /*break*/, 6];
                                                    ...
                                                    case 6:
                                                        ...
                                                        return [3 /*break*/, 1];
                                                    case 7:
                                                        data.push(__assign({ password: password, email: email }, generatedFields));
                                                        if ((_c = currentUser === null || currentUser === void 0 ? void 0 : currentUser.user) === null || _c === void 0 ? void 0 : _c.uid) {
                                                            ...
                                                            (0, firestore_1.setDoc)((0, firestore_1.doc)(collectionReference, currentUser.user.uid), __assign({ password: password, email: email }, generatedFields));
                                                        }
                                                        _d.label = 8;
