            ...
            switch (_e.label) {
                ...
                case 2:
                    ...
                    if (!(!fields[field] &&
                        ...
                        faker_1.default[field]())) return [3 /*break*/, 4];
                ...
                case 4:
                    if (!(fields[field].length > 1 &&
                        fields[field][0] === ':' &&
                        faker_1.default[fields[field].slice(1)])) return [3 /*break*/, 6];
                ...
                case 8:
                    ...
                    if (documents)
                        documents[i] = __assign(__assign({}, generatedFields), documents[i]);
                    else
                        data.push(generatedFields);
                    _e.label = 9;
                case 9:
                    i++;
                    return [3 /*break*/, 1];
                case 10:
                    ...
                    return [4 /*yield*/, Promise.all(documents.map(function (doc) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, (0, firestore_1.addDoc)(collectionReference, doc)];
                                    case 1:
                                        id = (_a.sent()).id;
                                        ids_1.push(id);
                                        return [2 /*return*/];
