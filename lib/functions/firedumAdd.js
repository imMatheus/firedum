        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    _e.label = 1;
                case 1:
                    if (!(i < numberOfDocuments)) return [3 /*break*/, 11];
                    _c = [];
                    for (_d in fields)
                        _c.push(_d);
                    _i = 0;
                ...
                case 2:
                    ...
                    if (!(fields[field].split(':').length > 1)) return [3 /*break*/, 5];
                    if (!fields[field].split(':')[1]) return [3 /*break*/, 4];
                ...
                case 5:
                    if (!!fields[field]) return [3 /*break*/, 8];
                    if (!faker_1.default[field]) return [3 /*break*/, 7];
                    if (!faker_1.default[field]()) return [3 /*break*/, 7];
                ...
                case 10:
                    ...
                    return [3 /*break*/, 1];
                case 11:
                    if (!documents) return [3 /*break*/, 13];
                    ids_1 = [];
