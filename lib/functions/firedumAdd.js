...
function firedumAdd(_a) {
	var collectionReference = _a.collectionReference,
		fields = _a.fields,
		_b = _a.numberOfDocuments,
		numberOfDocuments = _b === void 0 ? 1 : _b, // default is 1
		documents = _a.documents;
	return __awaiter(this, void 0, void 0, function () {
		var data, i, generatedFields, _c, _d, _i, field, value, ids_1, ids_2;
		var _this = this;
		return __generator(this, function (_e) {
			switch (_e.label) {
				...
				case 2:
					...
					if (!(typeof fields[field] === 'string')) return [3 /*break*/, 7];
					if (
						!(
							!fields[field] &&
				...
				case 4:
					if (
						!(
							...
							fields[field][0] === ':' &&
							faker_1.default[fields[field].slice(1)]
						)
					)
						return [3 /*break*/, 6];
				...
				case 8:
					...
					if (documents)
						documents[i] = __assign(
							__assign({}, generatedFields),
							documents[i]
						);
				...
				case 11:
					...
					return [
						2 /*return*/,
						{ documents: documents, ids: ids_1, reference: collectionReference }
					];
				case 12:
					ids_2 = [];
					return [
				...
				case 13:
					...
					return [
						2 /*return*/,
						{ data: data, ids: ids_2, reference: collectionReference }
					];
			}
		});
	});
